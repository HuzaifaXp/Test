...
import MensDress from '../pages/Categories/SelectedCategory/CategoriesBox';
...
useEffect(async()=>{
    ...
    // var list = await categoriesList();
    // setCategories({loading :false})
    // setCategories({...categories,categoriesList : list});
    // console.log('navbar page loaded', list)
        ...
        <div className="row border-top px-xl-5">
            <div className="col-lg-12">
                ...
                <Link  to={"/cart"} className="btn border" >
                    <i className="fas fa-shopping-cart text-primary cart-icon"></i>
