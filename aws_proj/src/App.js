...
<Routes>
  ...
  <Route  path='/cart' element={<Cart selItems={selItems} setSelItems={setSelItems} RemQty={RemQty}/>}></Route>
  <Route  path='/checkOut' element={<CheckOut selItems={selItems}  />}></Route>
  <Route  path='/admin/' element={<SignUp2 />}></Route>
  <Route  path='/confirmEmail' element={<EmailConfirmation />}></Route>
  <Route  path='/wishList' element={<WishList />}></Route>
  <Route  path='/huzaifa' element={<Admin />} ></Route>
